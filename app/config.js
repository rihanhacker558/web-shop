...
const products = [
    {
        ...
        items: [
            { value: 'panel-1gb', name: 'Paket 1 GB', price: 1067, specs: 'CPU Load: 10%, Memory: 512MB', badge: 'Termurah' },
            { value: 'panel-2gb', name: 'Paket 2 GB', price: 2067, specs: 'CPU Load: 20%, Memory: 1GB', badge: 'Termurah' },
            { value: 'panel-3gb', name: 'Paket 3 GB', price: 3067, specs: 'CPU Load: 30%, Memory: 2GB', badge: 'Termurah' },
            { value: 'panel-4gb', name: 'Paket 4 GB', price: 4067, specs: 'CPU Load: 40%, Memory: 4GB', badge: 'Termurah' },
            { value: 'panel-5gb', name: 'Paket 5 GB', price: 5067, specs: 'CPU Load: 50%, Memory: 8GB', badge: 'Termurah' },
            { value: 'panel-6gb', name: 'Paket 6 GB', price: 6067, specs: 'CPU Load: 60%, Memory: 12GB', badge: 'Termurah' },
            { value: 'panel-7gb', name: 'Paket 7 GB', price: 7067, specs: 'CPU Load: 70%, Memory: 16GB', badge: 'Termurah' },
            { value: 'panel-8gb', name: 'Paket 8 GB', price: 8067, specs: 'CPU Load: 80%, Memory: 24GB', badge: 'Termurah' },
            { value: 'panel-9gb', name: 'Paket 9 GB', price: 9067, specs: 'CPU Load: 90%, Memory: 32GB', badge: 'Termurah' },
            { value: 'panel-unl', name: 'Paket Unlimited', price: 14067, specs: 'CPU Load: Unlimited, Memory: Unlimited', badge: 'Termurah' }
        ]
    },
    {
        category: 'Paket VPS',
